document.addEventListener("DOMContentLoaded", function () {
  ...
  if (airtimeForm) {
    airtimeForm.addEventListener("submit", function (e) {
      ...
      console.log("Airtime form submitted with values:", {
        phone,
        amount,
        provider,
      });
  ...
  function addNewTransaction(amount, purpose) {
    ...
    const mobileTransactionsSection = document.querySelector(
      "#mobileView .transactions-section"
    );
    const webTransactionsSection = document.querySelector(
      "#webView .transactions-section"
    );
    ...
    if (mobileTransactionsSection) {
      const firstTransaction =
        mobileTransactionsSection.querySelector(".transaction-item");
      if (firstTransaction) {
    ...
    if (webTransactionsSection) {
      const firstTransaction =
        webTransactionsSection.querySelector(".transaction-item");
      if (firstTransaction) {
        firstTransaction.insertAdjacentHTML("beforebegin", transactionHTML);
      } else {
  ...
  document.addEventListener("click", function (e) {
    ...
    if (transactionItem) {
      ...
      if (!txData && transactionItem) {
        ...
        const amountElement = transactionItem.querySelector(
          ".transaction-amount"
        );
        const recipientElement = transactionItem.querySelector(
      ...
      const transactionDetailsPanel = document.getElementById(
  ...
  const closeTransactionDetails = document.getElementById(
